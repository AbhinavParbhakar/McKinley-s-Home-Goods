...
class Technology extends Component {
    ...
    render()
    {
        if (this.props.pValue === 4)
        {
            return(
                <div>
                    <div className="techPicDiv">
                        <img src="/Images/Technology.jpg" alt="tech" className="techPic"/>
                        <pre className="tech">Technology</pre>
                    </div>
                    <div className="sidebar">
                        <div><SearchBar handleChange={this.handleChange} department=" Technology "/></div>
