...
class Clothing extends Component {
    ...
    render()
    {
        if (this.props.pValue === 3)
        {
            return(
                <div>
                    <div className="clothingPicDiv">
                        <img src="/Images/Clothing.jpg" alt="clothing" className="clothingPic"/>
                        <pre className="clothing">Clothing</pre>
                        </div>
                    <div className="sidebar">
                        <div><SearchBar handleChange={this.handleChange} department=" Clothing "/></div>
