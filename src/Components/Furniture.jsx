...
class Furniture extends Component {
    ...
    render()
    {
        if (this.props.pValue === 5)
        {
            return(
                <div>
                    <div className="furniturePicDiv">
                        <img src="/Images/Furniture.jpg" alt="furniture" className="furniturePic"/>
                        <pre className="furniture">Furniture</pre>
                    </div>
                    <div className="sidebar">
                        <div><SearchBar handleChange={this.handleChange} department=" Furniture "/></div>
